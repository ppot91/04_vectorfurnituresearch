...
### TL;DR
- Upload chair photos, let Gemini describe them in rich JSON, embed the text via OpenRouter, and store vectors plus 200×200 previews in Supabase.
- Query with another image, regenerate its description/embedding, and surface the closest catalog matches ranked by cosine similarity.
